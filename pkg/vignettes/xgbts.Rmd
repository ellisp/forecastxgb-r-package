...
set.seed(123)
library(knitr)
opts_chunk$set(comment=NA, fig.width=7, fig.height=5, cache = FALSE)
```
...
## Advanced usage
The default settings for `xgbts` give reasonable results.  The key things that can be changed by the user include:
